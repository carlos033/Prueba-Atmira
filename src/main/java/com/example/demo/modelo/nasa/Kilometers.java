...
public class Kilometers implements Serializable {
    ...
    public Kilometers(double estimated_diameter_min, double estimated_diameter_max) {
    ...
    public String toString() {
        return "Kilometers{" + "estimated_diameter_min=" + estimated_diameter_min + ", estimated_diameter_max=" + estimated_diameter_max + '}';
    }
}
